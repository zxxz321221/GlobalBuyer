...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/MSAlertController/MSAlertController/MSAlertController.xib"
  install_resource "${PODS_ROOT}/MSAlertController/MSAlertController/MSAlertController_ActionSheet.xib"
