...
var widget = document.getElementById("translator-widget");
...
style.innerHTML = '@keyframes gelatine { from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } } @-webkit-keyframes gelatine { from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } }#translator-widget{position: fixed;width: 100px;height: 100px;text-align: center;right: 10px;bottom: 30%;color: rgb(255, 255, 255);z-index: 100000021;-webkit-box-sizing: border-box;box-sizing: border-box;font-size: 16px;font-family: sans-serif;-webkit-font-smoothing: antialiased;font-weight: bold;text-indent: initial;text-shadow: 1px 1px 1px #337314;letter-spacing: 1.5px;}';
head.appendChild(style);

var translatorWidget = document.getElementById('translator-widget');

translatorWidget.addEventListener("touchmove", function () {
    event.preventDefault();
    var scrollLeft = (event.targetTouches[0].pageX - -document.body.scrollLeft - 50);
    var scrollTop = (event.targetTouches[0].pageY - document.body.scrollTop - 50);
    var width = document.documentElement.clientWidth - 110;
    var height = document.documentElement.clientHeight - 110;

    try{
        if ( $$('meta[name=viewport]').attr('content') == "initial-scale=0.5, maximum-scale=0.5, minimum-scale=0.5, user-scalable=no" ) {
            width -= 110;
            height -= 110;
        }
    }catch(e){}
    ...
    if ( scrollLeft < 10 ) {
        translatorWidget.style.left = "10px";
    } else if ( scrollLeft > width ) {
        translatorWidget.style.left = width + "px";
    } else {
        translatorWidget.style.left = (event.targetTouches[0].pageX - -document.body.scrollLeft - 50) + "px";
    }

    if ( scrollTop < 10 ) {
        translatorWidget.style.top = "10px";
    } else if ( scrollTop > height ) {
        translatorWidget.style.top = height + "px";
    } else {
        translatorWidget.style.top = (event.targetTouches[0].pageY - document.body.scrollTop - 50) + "px";
    }
}, false);

translatorWidget.innerHTML = '<div><img style="width: 100px;" src="//buy.dayanghang.net/inject/img/' + getBrowserLanguage() + '.png" /></div>';

translatorWidget.onclick = function(){
    ...
    if (!error) {
        ...
        for (var i = 0; i < queryDict.length; i++) {
            ...
            TranslateApi.getJSON(url, {
                ...
                console.log('loading translate url error!');
...
style.innerHTML = '@keyframes gelatine { from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } } @-webkit-keyframes gelatine { from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } from, to 0%{ -webkit-transform: scale(1, 1); transform: scale(1, 1); } 25% { -webkit-transform: scale(0.9, 1.1); transform: scale(0.9, 1.1); } 50% { -webkit-transform: scale(1.1, 0.9); transform: scale(1.1, 0.9); } 75% { -webkit-transform: scale(0.95, 1.05); transform: scale(0.95, 1.05); } }#translator-widget{position: fixed;width: 100px;height: 100px;text-align: center;right: 10px;bottom: 30%;color: rgb(255, 255, 255);z-index: 100000021;-webkit-box-sizing: border-box;box-sizing: border-box;font-size: 16px;font-family: sans-serif;-webkit-font-smoothing: antialiased;font-weight: bold;text-indent: initial;text-shadow: 1px 1px 1px #337314;letter-spacing: 1.5px;}.translator-widget-loading {display:none; position: absolute; top: 50%; margin-top: -15px; left: 50%; margin-left: -28px;}.translator-widget-loading > div:nth-child(1), .translator-widget-loading > div:nth-child(5) { -webkit-animation-delay: 0.4s !important; animation-delay: 0.4s !important; } .translator-widget-loading > div { background-color: #f6371ccc; width: 5px; height: 30px; border-radius: 2px; margin: 3.5px; -webkit-animation-fill-mode: both; animation-fill-mode: both; display: inline-block; -webkit-animation: line-scale-pulse-out 0.9s 0s infinite cubic-bezier(.85, .25, .37, .85); animation: line-scale-pulse-out 0.9s 0s infinite cubic-bezier(.85, .25, .37, .85); animation-delay: 0s; } .translator-widget-loading > div:nth-child(2), .translator-widget-loading > div:nth-child(4) { -webkit-animation-delay: 0.2s !important; animation-delay: 0.2s !important; } @keyframes line-scale-pulse-out { 0% { -webkit-transform: scaley(1); transform: scaley(1); } 50% { -webkit-transform: scaley(0.4); transform: scaley(0.4); } 100% { -webkit-transform: scaley(1); transform: scaley(1); } } @-webkit-keyframes line-scale-pulse-out { 0% { -webkit-transform: scaley(1); transform: scaley(1); } 50% { -webkit-transform: scaley(0.4); transform: scaley(0.4); } 100% { -webkit-transform: scaley(1); transform: scaley(1); } }';
head.appendChild(style);
    
translatorWidget = document.getElementById('translator-widget');
...
translatorWidget.innerHTML = '<div class="translator-widget-loading"><div></div><div></div><div></div><div></div><div></div></div><div class="translator-widget-img"><img style="width: 100px;" src="//buy.dayanghang.net/inject/img/' + getBrowserLanguage() + '.png" /></div>';

translatorWidget.onclick = function(){
    to = getBrowserLanguage();
    document.querySelector('.translator-widget-loading').style.display = 'inline-block';
    (new Tautologistics.NodeHtmlParser.Parser(handler)).parseComplete(document.body.innerHTML);
}