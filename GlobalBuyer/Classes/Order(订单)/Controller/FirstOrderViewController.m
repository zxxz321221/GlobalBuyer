...
@interface FirstOrderViewController ()<UITableViewDelegate,UITableViewDataSource,FirstFooterViewDelegate>
@property (nonatomic , strong) UITableView * tableView;

@end

@implementation FirstOrderViewController
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[FirstOrderFooterView class] forHeaderFooterViewReuseIdentifier:@"cityFooterSectionID"];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    FirstOrderFooterView * footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:footerSectionID];
    if (footerView == nil) {
        footerView = [[FirstOrderFooterView alloc]initWithReuseIdentifier:footerSectionID];
    }
