//
//  TailToBePaidDetailViewController.m
//  GlobalBuyer
//
...
#import "TailToBePaidDetailViewController.h"
#import "FirstTreatCell.h"
#import "StorageCell.h"
#import "TailToBePaidCell.h"
#import "GoodsToBeReceivedCell.h"
@interface TailToBePaidDetailViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
{
...
@implementation TailToBePaidDetailViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    dic = [NSMutableDictionary dictionary];
    NSDictionary * dict = @{@"1":@"1",@"2":@"1",@"3":@"1",@"4":@"0"};
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    if (section == 0) {
        return [Unity countcoordinatesH:582]+NavBarHeight+[Unity countcoordinatesH:90];
    }
...
- (UIView *)orderProcessView{
    if (!_orderProcessView) {
        _orderProcessView = [[UIView alloc]initWithFrame:CGRectMake(0, _firstView.bottom+[Unity countcoordinatesH:10], kScreenW, [Unity countcoordinatesH:40])];
...
- (UIButton *)cancelBtn{
    if (!_cancelBtn) {
        _cancelBtn = [[UIButton alloc]initWithFrame:CGRectMake(kScreenW-[Unity countcoordinatesW:200], [Unity countcoordinatesH:10], [Unity countcoordinatesW:110], [Unity countcoordinatesH:30])];
        [_cancelBtn addTarget:self action:@selector(photoClick) forControlEvents:UIControlEventTouchUpInside];
        [_cancelBtn setTitle:@"查看验货照片" forState:UIControlStateNormal];
        _cancelBtn.layer.borderColor = [[Unity getColor:@"#b445c8"] CGColor];
        _cancelBtn.layer.borderWidth = 1.0f;
        [_cancelBtn setTitleColor:[Unity getColor:@"#b445c8"] forState:UIControlStateNormal];
