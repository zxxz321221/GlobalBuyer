...
@interface GoodsOrderViewController ()<UITableViewDelegate,UITableViewDataSource,GoodsFooterViewDelegate>
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[GoodsFooterView class] forHeaderFooterViewReuseIdentifier:@"cityFooterSectionID"];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    GoodsFooterView * footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:footerSectionID];
    if (footerView == nil) {
        footerView = [[GoodsFooterView alloc]initWithReuseIdentifier:footerSectionID];
    }
