...
@interface TailOrderViewController ()<UITableViewDelegate,UITableViewDataSource,TailFooterViewDelegate>
@property (nonatomic , strong) UITableView * tableView;

@end

@implementation TailOrderViewController
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[TailFooterView class] forHeaderFooterViewReuseIdentifier:@"cityFooterSectionID"];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    TailFooterView * footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:footerSectionID];
    if (footerView == nil) {
        footerView = [[TailFooterView alloc]initWithReuseIdentifier:footerSectionID];
    }
