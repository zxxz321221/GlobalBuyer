...
-(NSMutableArray *)dataSoucer {
    if (_dataSoucer == nil) {
        ...
        [_dataSoucer addObject:@"全部"];
        [_dataSoucer addObject:@"待支付"];
        [_dataSoucer addObject:@"提交地址"];
        [_dataSoucer addObject:@"采购中"];
        [_dataSoucer addObject:@"支付运费"];
        [_dataSoucer addObject:@"海外发货"];
    }
    return _dataSoucer;
}
