...
- (void)initLayout
{
    ...
    self.editBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, 30, 20, 20)];
    [self.editBtn setImage:[UIImage imageNamed:@"勾选边框"] forState:UIControlStateNormal];
    [self.editBtn setImage:[UIImage imageNamed:@"勾选"] forState:UIControlStateSelected];
