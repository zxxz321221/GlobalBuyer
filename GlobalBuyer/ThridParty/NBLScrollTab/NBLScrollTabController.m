...
- (instancetype)initWithTabTheme:(NBLScrollTabTheme *)tabTheme
{
    ...
    if (self) {
        ...
        _tabTheme.indicatorViewColor = _tabTheme.indicatorViewColor ? _tabTheme.indicatorViewColor : [UIColor colorWithPatternImage:[UIImage imageNamed:@"NBLS.png"]];
    }
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _tabTheme.indicatorViewColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"NBLS.png"]];
    }
    return self;
}
