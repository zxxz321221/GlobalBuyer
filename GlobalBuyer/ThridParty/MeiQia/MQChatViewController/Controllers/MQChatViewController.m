...
- (void)dealloc {
    [[NSUserDefaults standardUserDefaults]setObject:@"NO" forKey:@"isChating"];
...
- (void)viewDidLoad {
    ...
    [[NSUserDefaults standardUserDefaults]setObject:@"YES" forKey:@"isChating"];
    [[NSUserDefaults standardUserDefaults]setObject:@"YES" forKey:@"ChatState"];
    [self presentUI];
}
